...
func (_m *PlayerDB) GetPlayer(ctx context.Context, playerID string) (*gamesvc.Player, error) {
...
func (_c *PlayerDB_GetPlayer_Call) Return(_a0 *gamesvc.Player, _a1 error) *PlayerDB_GetPlayer_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

// SetPlayer provides a mock function with given fields: ctx, p
func (_m *PlayerDB) SetPlayer(ctx context.Context, p *gamesvc.Player) error {
	ret := _m.Called(ctx, p)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *gamesvc.Player) error); ok {
		r0 = rf(ctx, p)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *PlayerDB_SetPlayer_Call) Run(run func(ctx context.Context, p *gamesvc.Player)) *PlayerDB_SetPlayer_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*gamesvc.Player))
	})
	return _c
}
